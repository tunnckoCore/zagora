---
description: "Avoid redundant computations. Zagora supports caching via a simple adapter interface, allowing you to memoize expensive operations."
head:
  - - meta
    - property: og:description
      content: "Avoid redundant computations. Zagora supports caching via a simple adapter interface, allowing you to memoize expensive operations."
---
