---
description: "Sync and async procedure inference. Zagora dynamically infers whether a procedure is sync or async based on your handler and schemas."
head:
  - - meta
    - property: og:description
      content: "Sync and async procedure inference. Zagora dynamically infers whether a procedure is sync or async based on your handler and schemas."
---
