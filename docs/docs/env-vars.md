---
description: "Type-safe env var validation. Zagora lets you validate environment variables with the same schema system used for inputs and outputs."
head:
  - - meta
    - property: og:description
      content: "Type-safe env var validation. Zagora lets you validate environment variables with the same schema system used for inputs and outputs."
---
