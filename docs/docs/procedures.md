---
description: "The building blocks of Zagora. A procedure is a type-safe, error-safe function built with the fluent builder API. Procedures validate inputs, execute handlers, and return predictable results."
head:
  - - meta
    - property: og:description
      content: "The building blocks of Zagora. A procedure is a type-safe, error-safe function built with the fluent builder API. Procedures validate inputs, execute handlers, and return predictable results."
---
