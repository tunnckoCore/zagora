---
description: "Why use Zagora over Zod/Valibot alone. **Philosophy**: Standalone validators are great for data validation but require boilerplate for function composition."
head:
  - - meta
    - property: og:description
      content: "Why use Zagora over Zod/Valibot alone. **Philosophy**: Standalone validators are great for data validation but require boilerplate for function composition."
---
