---
description: "DIY routing patterns with Zagora. Zagora doesn't include routers by design—it focuses on individual procedures."
head:
  - - meta
    - property: og:description
      content: "DIY routing patterns with Zagora. Zagora doesn't include routers by design—it focuses on individual procedures."
---
...
- **[Generating OpenAPI](/advanced/openapi)** - Create API documentation from your procedures
- **[Testing Procedures](/advanced/testing)** - How to test Zagora procedures effectively
- **[Best Practices](/advanced/best-practices)** - Guidelines for production usage
