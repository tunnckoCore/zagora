...
<HomePage.Root>
  ...
  <HomePage.InstallPackage name="zagora" type="install" />
  <HomePage.Buttons>
    <HomePage.Button href="/docs/getting-started" variant="accent">Get Started</HomePage.Button>
    <HomePage.Button href="https://github.com/tunnckoCore/zagora">GitHub</HomePage.Button>
  </HomePage.Buttons>
</HomePage.Root>
...
- [**vs neverthrow / Effect.ts**](/comparisons/error-libraries) - Error handling approaches compared
